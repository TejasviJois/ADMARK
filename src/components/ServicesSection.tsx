...
import { Globe, Cloud, Settings, ShoppingCart, CalendarCheck, RefreshCw } from "lucide-react";
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <motion.div
            ...
            className="group p-6 rounded-2xl bg-card border border-border shadow-card cursor-default relative overflow-hidden"
          >
